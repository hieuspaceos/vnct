    ...
    <div class="col-md-10 offset-md-1">
        <div class="card">
            <div class="card-header">
                <h4>Thêm Portfolio mới</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" name="lang"  value="{{ \App::getLocale()}}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-group anhdaidien">
                                <div class="box-form d-flex gap-2">
                                    <input type="text" name="avatar" id="avatar" readonly value="{{ old('avatar') }}" class="form-control @error('avatar') is-invalid @enderror">
                                    <button type="button" class="btn btn-primary" onclick="selectFileWithCKFinder('avatar','imageDD','members:/')">
                            ...
                            <img class="img-anhdaidien mt-2" id="imageDD" src="/template/admin/image/noimage.jpg" style="max-width: 200px; border: 1px solid #ddd; padding: 5px;">
                            @error('avatar')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="type" class="form-select @error('type') is-invalid @enderror">
                                ...
                                <option value="Negocio" {{ old('type') == 'Negocio' ? 'selected' : '' }}>Negocio</option>
                                <option value="Individual" {{ old('type') == 'Individual' ? 'selected' : '' }}>Individual</option>
                                <option value="Organización" {{ old('type') == 'Organización' ? 'selected' : '' }}>Organización</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            @else
                             <select name="type" class="form-select @error('type') is-invalid @enderror">
                                <option value="">-- Chọn loại --</option>
                                <option value="Việc kinh doanh" {{ old('type') == 'Việc kinh doanh' ? 'selected' : '' }}>Việc kinh doanh</option>
                                <option value="Cá nhân" {{ old('type') == 'Cá nhân' ? 'selected' : '' }}>Cá nhân</option>
                                <option value="Tổ chức" {{ old('type') == 'Tổ chức' ? 'selected' : '' }}>Tổ chức</option>
                            </select>
                            @endif
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="area_of_operation" class="form-control" value="{{ old('area_of_operation') }}">
                        </div>
