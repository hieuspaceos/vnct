    ...
    <div class="col-md-10 offset-md-1">
        <div class="card">
            <div class="card-header">
                <h4>{{$title}}: {{ $portfolio->name }}</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" name="lang"  value="{{$lang}}">
            <input type="hidden" class="form-control" name="origin_id"  value="{{$portfolio->id}}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mota">
                                ...
                                <textarea  name="content" rows="5" >{{ old('content', $portfolio->content) }}</textarea>
                            </div>
                    </div>
