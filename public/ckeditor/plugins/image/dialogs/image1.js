        ...
        return {
            ...
            onOk: function () {
                ...
                if (this.imageEditMode) {
                    ...
                    "image" == k ? (this.imageElement = d.document.createElement("picture")) : ((this.imageElement = d.document.createElement("input")), this.imageElement.setAttribute("type", "image")),                   
                    link = d.document.createElement('img');
                    source = d.document.createElement('source');
                    source2 = d.document.createElement('source');
                    src = this.getContentElement('info','txtUrl').getInputElement().$.value;
                    this.imageElement.append(source);
                    this.imageElement.append(source2);
                    this.imageElement.append(link);
                    httpGet(src);
                    source.setAttribute("srcset",src+".webp");
                    source.setAttribute("type","image/webp");
                    source2.setAttribute("srcset",src);
                    source2.setAttribute("type","image/jpeg");
                    this.commitContent( 1,link); 
...
function httpGet(url)
{
   ...
   xmlHttp.open( "GET",''+ editor.plugins.image.path + 'create.php?url='+url+'&Math.random()', false ); // false for synchronous request
   xmlHttp.send( null );
   //console.log( xmlHttp.responseText);     
   var data = xmlHttp.responseText; 
   console.log(''+ editor.plugins.image.path + '/create.php?url='+url+'&Math.random()');   
   //return data;    
}